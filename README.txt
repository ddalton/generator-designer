java -jar target/odor-1.0-SNAPSHOT-jar-with-dependencies.jar -c "jdbc:h2:mem:db2;autocommit=off;USER=sa;PASSWORD=123" -r "org.h2.Driver" -s "/Users/i844711/Downloads/odor/schema.sql" -u "sa" -p "123" -d "//"
